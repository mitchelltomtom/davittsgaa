...
const producer = {
  ...
  teamRank: (res) => {
    //Mocked
    const eastData = [["bos","Boston","Celtics",null,null,"bos",null,2,3],["cle","Cleveland","Cavaliers",null,null,"cle",null,2,3]];//res.resultSets[4].rowSet
    const westData = [["bos","Boston","Celtics",null,null,"bos",null,2,3],["cle","Cleveland","Cavaliers",null,null,"cle",null,2,3]];//res.resultSets[5].rowSet
